                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($diplomas as $diploma)
										...
										<td >{{ $diploma->evento_id }}</td>
										<td >{{ $diploma->fondo }}</td>
										<td >{{ $diploma->descripcion }}</td>
										<td >{{ $diploma->es_borrable }}</td>

                                            <td>
                                                <form action="{{ route('diplomas.destroy', $diploma->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('diplomas.show', $diploma->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
