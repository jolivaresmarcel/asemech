<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="compra_id" class="form-label">{{ __('Compra Id') }}</label>
            <input type="text" name="compra_id" class="form-control @error('compra_id') is-invalid @enderror" value="{{ old('compra_id', $transaccione?->compra_id) }}" id="compra_id" placeholder="Compra Id">
            {!! $errors->first('compra_id', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
