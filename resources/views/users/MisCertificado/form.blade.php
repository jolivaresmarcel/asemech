<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <input type="hidden" name="user_id" class="form-control @error('user_id') is-invalid @enderror" value="{{ old('user_id', $certificado?->user_id) }}" id="user_id" placeholder="User Id">
        <input type="hidden" name="es_valido" class="form-control @error('es_valido') is-invalid @enderror" value="{{ old('es_valido', $certificado?->es_valido) }}" id="es_valido" placeholder="Es Valido">
